...
const OtpVerify = () => {
  ...
  async function resendOtp() {
    ...
    try {
      const res = await fetch(endpoints.RESEND_OTP, options);
  ...
  return (
    <section className="custom-scroll no-scrollbar flex h-full min-h-dvh flex-col px-5 py-7">
      ...
      <div className="flex min-h-[60%] grow flex-col items-center justify-center">
